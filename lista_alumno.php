  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
            <a class="nav-link" href="lista_alumnos.php">Alumnos</a>
        </li>
        <li class="nav-item">
    ...
    @method("put")
        ...
        <tbody>
            <tr>
                ...
                <td><a href="{{route('alumno.reporte', $fila->id)}}"><button class="btn btn-outline-primary btn-block" id="btn1">Ver reporte</button></a><br><br>
                <a href="{{route('alumno.nuevoReporte', $fila->id)}}"><button class="btn btn-outline-primary btn-block" id="btn1" style="height: 42px; font-size: 15px">Nuevo reporte</button></a></td>
                <td><a href="{{route('alumno.nuevaCita', $fila->id)}}"><button class="btn btn-outline-success btn-block" id="btn1">Añadir cita</button></a></td>
            </tr>
        </tbody>
            @endforeach
    </table><br><br>
